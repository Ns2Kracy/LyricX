...
function About() {
  return (
    <main class="min-h-[100dvh] px-4 py-16 text-[#111111] sm:px-6 lg:px-8">
      <section class="mx-auto max-w-5xl">
        ...
        <p class="mt-6 max-w-3xl text-lg leading-8 text-[#525252]">
      ...
      <section class="mx-auto mt-12 grid max-w-5xl gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <article class="rounded-lg border border-black/10 bg-white/65 p-6 shadow-sm">
          ...
          <p class="mt-4 text-base leading-7 text-[#525252]">
        ...
        <article class="rounded-lg border border-black/10 bg-[#fbfbf8] p-6 shadow-sm">
          ...
          <ul class="mt-5 space-y-3 text-base text-[#525252]">
