...
function Home() {
  return (
    <main class="min-h-[100dvh] text-[#111111]">
        ...
        <div class="max-w-3xl">
          ...
          <div class="mt-10 grid max-w-2xl grid-cols-1 gap-3 text-sm text-[#525252] sm:grid-cols-3">
            <div class="border-l border-black/15 pl-4">
              <strong class="block text-[#111111]">macOS 14+</strong>
              SwiftUI menu-bar app
            </div>
            <div class="border-l border-black/15 pl-4">
              <strong class="block text-[#111111]">Spotify desktop</strong>
              Local playback polling
            </div>
            <div class="border-l border-black/15 pl-4">
              <strong class="block text-[#111111]">No account flow</strong>
      ...
      <section id="features" class="border-y border-black/10 bg-white/55 px-4 py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-7xl">
          <div class="max-w-2xl">
            ...
            <h2 class="text-3xl font-semibold leading-tight text-[#111111] sm:text-5xl">
              A tiny surface for a very specific habit.
            </h2>
            <p class="mt-5 text-base leading-7 text-[#525252]">
          ...
          <div class="mt-10 grid gap-4 lg:grid-cols-6">
            {featureCards.map((feature) => (
              <article class={`rounded-lg border border-black/10 bg-[#fbfbf8] p-6 shadow-sm ${feature.class}`}>
                <h3 class="text-xl font-semibold text-[#111111]">{feature.title}</h3>
                <p class="mt-3 max-w-2xl text-base leading-7 text-[#525252]">{feature.body}</p>
              </article>
            ))}
          </div>
        </div>
          ...
          <div class="grid gap-4">
            {workflowSteps.map(([title, body]) => (
              <article class="rounded-lg border border-black/10 bg-white/65 p-6 shadow-sm">
                <h3 class="text-lg font-semibold text-[#111111]">{title}</h3>
                <p class="mt-2 text-base leading-7 text-[#525252]">{body}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section id="download" class="bg-[#111111] px-4 py-16 text-white sm:px-6 lg:px-8">
        <div class="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_0.85fr] lg:items-center">
          <div>
            ...
            <p class="mt-5 max-w-2xl text-base leading-7 text-[#d4d4d4]">
