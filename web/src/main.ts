  ...
  app.innerHTML = `
    <header class="sticky top-0 z-50 border-b border-black/10 bg-[#f7f7f2]/85 backdrop-blur-xl">
      <nav class="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:px-8">
        <a href="#top" class="flex min-w-0 items-center gap-3 text-[#111111] no-underline">
          <span class="flex size-8 shrink-0 items-center justify-center rounded-lg bg-[#111111] text-[13px] font-semibold text-white">LX</span>
    ...
    <main id="top" class="min-h-[100dvh] text-[#111111]">
      <section class="mx-auto grid max-w-7xl gap-12 px-4 pb-16 pt-16 sm:px-6 sm:pb-20 sm:pt-20 lg:min-h-[calc(100dvh-4rem)] lg:grid-cols-[1fr_0.92fr] lg:items-center lg:px-8 lg:pt-14">
        <div class="max-w-3xl">
          <p class="mb-5 inline-flex rounded-full border border-black/10 bg-white/70 px-3 py-1 text-sm font-medium text-[#404040] shadow-sm">
            Native macOS menu-bar lyrics for Spotify
          </p>
          <h1 class="max-w-4xl text-5xl font-semibold leading-[1.02] text-[#111111] sm:text-6xl lg:text-7xl">
            Spotify lyrics, right where your eyes already are.
          </h1>
          <p class="mt-6 max-w-2xl text-lg leading-8 text-[#525252] sm:text-xl">
          ...
          <div class="mt-10 grid max-w-2xl grid-cols-1 gap-3 text-sm text-[#525252] sm:grid-cols-3">
            <div class="border-l border-black/15 pl-4"><strong class="block text-[#111111]">macOS 14+</strong>SwiftUI menu-bar app</div>
            <div class="border-l border-black/15 pl-4"><strong class="block text-[#111111]">Spotify desktop</strong>Local playback polling</div>
            <div class="border-l border-black/15 pl-4"><strong class="block text-[#111111]">No account flow</strong>No Spotify OAuth in v1</div>
          </div>
        </div>
        ...
        <div class="relative mx-auto w-full max-w-[560px]" aria-label="LyricX menu bar preview" role="img">
          <div class="relative rounded-lg border border-black/10 bg-[#d9d9d2] p-3 shadow-[0_30px_90px_rgba(10,10,10,0.16)]">
            <div class="rounded-lg border border-black/10 bg-[#111111] p-4 text-white">
              <div class="flex h-9 items-center gap-4 border-b border-white/10 text-xs text-[#a3a3a3]">
              ...
              <div class="py-8">
                <div class="mb-5 rounded-lg border border-white/10 bg-white/[0.04] p-4">
                  <p class="text-sm text-[#a3a3a3]">Current track</p>
                ...
                <div class="overflow-hidden rounded-lg border border-white/10 bg-black p-5">
                  ...
                  <p class="mt-3 text-sm text-[#a3a3a3]">Next line is ready before you need it</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="features" class="border-y border-black/10 bg-white/55 px-4 py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-7xl">
          <div class="max-w-2xl">
            ...
            <h2 class="text-3xl font-semibold leading-tight text-[#111111] sm:text-5xl">A tiny surface for a very specific habit.</h2>
            <p class="mt-5 text-base leading-7 text-[#525252]">The app is intentionally narrow: keep lyrics visible, avoid extra login work, and stay out of the way when lyrics are missing.</p>
          </div>
          <div class="mt-10 grid gap-4 lg:grid-cols-6">
            <article class="rounded-lg border border-black/10 bg-[#fbfbf8] p-6 shadow-sm lg:col-span-3">
              <h3 class="text-xl font-semibold text-[#111111]">Lives in the menu bar</h3>
              <p class="mt-3 max-w-2xl text-base leading-7 text-[#525252]">The active lyric line sits where your eyes already glance, without taking over the desktop.</p>
            </article>
            <article class="rounded-lg border border-black/10 bg-[#fbfbf8] p-6 shadow-sm lg:col-span-3">
              <h3 class="text-xl font-semibold text-[#111111]">Built for Spotify desktop</h3>
              <p class="mt-3 max-w-2xl text-base leading-7 text-[#525252]">LyricX reads local playback state through AppleScript, so the first version avoids OAuth setup.</p>
            </article>
            <article class="rounded-lg border border-black/10 bg-[#fbfbf8] p-6 shadow-sm lg:col-span-2">
              <h3 class="text-xl font-semibold text-[#111111]">Synced by LRCLIB</h3>
              <p class="mt-3 max-w-2xl text-base leading-7 text-[#525252]">Timed LRC lyrics are fetched, parsed, cached locally, and matched to the current playback position.</p>
            </article>
            <article class="rounded-lg border border-black/10 bg-[#fbfbf8] p-6 shadow-sm lg:col-span-2">
              <h3 class="text-xl font-semibold text-[#111111]">Graceful fallbacks</h3>
              <p class="mt-3 max-w-2xl text-base leading-7 text-[#525252]">When synced lyrics are missing, the app keeps polling Spotify and can show the current track instead.</p>
            </article>
            <article class="rounded-lg border border-black/10 bg-[#fbfbf8] p-6 shadow-sm lg:col-span-2">
              <h3 class="text-xl font-semibold text-[#111111]">Small by design</h3>
              <p class="mt-3 max-w-2xl text-base leading-7 text-[#525252]">A native SwiftUI menu-bar app with focused controls for visibility, refresh, and quit.</p>
            </article>
          </div>
        </div>
      </section>
      ...
      <section id="workflow" class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <h2 class="text-3xl font-semibold leading-tight text-[#111111] sm:text-5xl">Local first, quiet when the network is not.</h2>
          </div>
          <div class="grid gap-4">
            <article class="rounded-lg border border-black/10 bg-white/65 p-6 shadow-sm"><h3 class="text-lg font-semibold text-[#111111]">Spotify plays</h3><p class="mt-2 text-base leading-7 text-[#525252]">The local desktop app exposes track, artist, duration, state, and playback position.</p></article>
            <article class="rounded-lg border border-black/10 bg-white/65 p-6 shadow-sm"><h3 class="text-lg font-semibold text-[#111111]">Lyrics match</h3><p class="mt-2 text-base leading-7 text-[#525252]">LyricX looks up synced lyrics, caches the LRC, and keeps misses non-fatal.</p></article>
            <article class="rounded-lg border border-black/10 bg-white/65 p-6 shadow-sm"><h3 class="text-lg font-semibold text-[#111111]">The line updates</h3><p class="mt-2 text-base leading-7 text-[#525252]">The current lyric moves through the menu bar with stable width and readable contrast.</p></article>
          </div>
        </div>
      </section>

      <section id="download" class="bg-[#111111] px-4 py-16 text-white sm:px-6 lg:px-8">
