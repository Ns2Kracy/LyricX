...
struct LyricXUnitTests {
    ...
    private static func runPlaybackAndMenuBarTests() async throws {
        ...
        try await testSpotifyServiceRunsControlCommand()
        try await testSpotifyParseReadsArtworkURL()
        ...
        try testMenuBarStatusItemKeepsShortLyricsCompact()
        ...
        try testMenuBarLayoutSupportsNoTrailingPaddingNextToArtwork()
